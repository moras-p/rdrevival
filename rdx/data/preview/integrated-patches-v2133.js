// Generated v2.1.33 shipped patch baseline. Do not edit browser-local review state here.
export const INTEGRATED_PREVIEW_PATCH_BASELINE = {
  ...
  "purpose": "Shipped integration baseline. Rows here are already represented by v2.1.33 source/preview behavior and must not be re-exported unless the reviewer changes them.",
  ...
  "rooms": [
    {
      ...
      "patches": [
        ...
        {
          "elementId": "MD0011#debug-hazard#bounds:hazard:mark:93",
          "sourceKey": "mark:93",
          "instanceKey": null,
          "traceCollection": "actors",
          "elementKind": "debug-hazard",
          ...
          "change": {
            ...
            "dy": 2,
            "enabled": true,
            "bugged": "new updated location - proper one"
          },
          "updatedAt": "2026-08-07T09:51:48.266Z",
          "introducedInVersion": "2.1.30",
          "integratedInVersion": "2.1.31"
        },
        {
